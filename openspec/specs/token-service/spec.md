# Spec — US-005 · TokenService (+ US-007 delta: findByContractAddress)

> **Change:** `US-005-wallet-token-crud` (base) + `US-007-portfolio-api` (delta)
> **Capability:** TokenService — gestión de tokens ON_CHAIN y CEX; búsqueda por contract_address
> **Estado:** actualizado
...
## 7. TokenService.findByContractAddress (ADDED en US-007)
